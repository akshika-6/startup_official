...
const DashboardHome = () => {
  ...
  // Now, all calls to action from DashboardHome will redirect to the
  // main /dashboard route (which renders DashboardInstructions.jsx)
  const getDashboardPath = () => {
    if (!user) {
      return '/login'; // If no user, always redirect to login
    }
    // For any authenticated user, direct them to the main internal dashboard entry point
    return '/dashboard'; // <--- CHANGED THIS LINE
  };
  ...
  return (
    <div className="min-h-screen bg-theme-bg text-theme-text">
      {/* NO NAVBAR HERE: DashboardHomeNavbar is rendered in App.jsx */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {/* Primary Button */}
                {/* Changed <a> to <Link> for React Router navigation */}
                ...
                <div className="bg-theme-card-bg rounded-xl p-6 space-y-4">
                  ...
                  <div className="bg-theme-input-bg rounded-lg p-4 space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold text-theme-text">83%</span> {/* Changed to text-theme-text */}
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    {/* Primary button style for View Pitch */}
      ...
      {user && (
        <section className="py-16 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            {/* Inverse primary button for contrast on gradient */}
            {/* Changed <a> to <Link> for React Router navigation */}
      ...
      {/* Stats Section */}
      <section className="py-16 px-6 bg-theme-section-bg transition-colors duration-300"> {/* CHANGED THIS LINE */}
        <div className="max-w-7xl mx-auto">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            {/* Inverse secondary button for contrast on gradient */}
