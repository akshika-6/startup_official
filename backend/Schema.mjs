...
const InvestorPreferenceSchema = new Schema({
  ...
  domain: { type: String }, // maps to areasOfInterest
  stage: { type: String }, // maps to investmentAmount
  fundingRange: {
    min: { type: Number },
    max: { type: Number },
  },
...
export const Startup =
  mongoose.models.Startup || model("Startup", StartupSchema);
export const InvestorPreference =
  mongoose.models.InvestorPreference ||
  model("InvestorPreference", InvestorPreferenceSchema);
